...
class FileId:
    ...
    def __init__(
        ...
        thumbnail_source: typing.Optional[ThumbnailSource] = None,
        thumbnail_file_type: typing.Optional[FileType] = None,
        thumbnail_size: str = "",
        secret: typing.Optional[int] = None,
        local_id: typing.Optional[int] = None,
        chat_id: typing.Optional[int] = None,
        chat_access_hash: typing.Optional[int] = None,
        sticker_set_id: typing.Optional[int] = None,
    ...
    def encode(self, *, major: typing.Optional[int] = None, minor: typing.Optional[int] = None):
