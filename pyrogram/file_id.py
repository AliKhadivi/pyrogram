...
class FileId:
    ...
    def __init__(
        ...
        media_id: typing.Optional[typing.Optional[int]] = None,
        access_hash: typing.Optional[typing.Optional[int]] = None,
        volume_id: typing.Optional[typing.Optional[int]] = None,
        thumbnail_source: typing.Optional[typing.Optional[ThumbnailSource]] = None,
        thumbnail_file_type: typing.Optional[typing.Optional[FileType]] = None,
        thumbnail_size: str = "",
        secret: typing.Optional[typing.Optional[int]] = None,
        local_id: typing.Optional[typing.Optional[int]] = None,
        chat_id: typing.Optional[typing.Optional[int]] = None,
        chat_access_hash: typing.Optional[typing.Optional[int]] = None,
        sticker_set_id: typing.Optional[typing.Optional[int]] = None,
    ...
    def encode(self, *, major: typing.Optional[typing.Optional[int]] = None, minor: typing.Optional[typing.Optional[int]] = None):
