...
try:
    ...
    def ctr256_encrypt(data: bytes, key: bytes, iv: bytearray, state: typing.Optional[bytearray] = None) -> bytes:
        return tgcrypto.ctr256_encrypt(data, key, iv, state or bytearray(1))


    def ctr256_decrypt(data: bytes, key: bytes, iv: bytearray, state: typing.Optional[bytearray] = None) -> bytes:
