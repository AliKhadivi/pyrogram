...
class Client(Methods):
    ...
    def __init__(
        ...
        api_hash: typing.Optional[typing.Optional[str]] = None,
        app_version: str = APP_VERSION,
        device_model: str = DEVICE_MODEL,
        system_version: str = SYSTEM_VERSION,
        lang_code: str = LANG_CODE,
        ipv6: bool = False,
        proxy: typing.Optional[typing.Optional[dict]] = None,
        test_mode: bool = False,
        bot_token: typing.Optional[typing.Optional[str]] = None,
        session_string: typing.Optional[typing.Optional[str]] = None,
        in_memory: typing.Optional[typing.Optional[bool]] = None,
        phone_number: typing.Optional[typing.Optional[str]] = None,
        phone_code: typing.Optional[typing.Optional[str]] = None,
        password: typing.Optional[typing.Optional[str]] = None,
        workers: int = WORKERS,
        workdir: str = WORKDIR,
        plugins: typing.Optional[typing.Optional[dict]] = None,
        parse_mode: "enums.ParseMode" = enums.ParseMode.DEFAULT,
        no_updates: typing.Optional[typing.Optional[bool]] = None,
        takeout: typing.Optional[typing.Optional[bool]] = None,
