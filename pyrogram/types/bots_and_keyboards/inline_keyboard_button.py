...
class InlineKeyboardButton(Object):
    ...
    def __init__(
        ...
        web_app: typing.Optional[typing.Optional[typing.Optional["types.WebAppInfo"]]] = None,
        login_url: typing.Optional[typing.Optional[typing.Optional["types.LoginUrl"]]] = None,
        user_id: typing.Optional[typing.Optional[typing.Optional[int]]] = None,
        switch_inline_query: typing.Optional[typing.Optional[typing.Optional[str]]] = None,
        switch_inline_query_current_chat: typing.Optional[typing.Optional[typing.Optional[str]]] = None,
