    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    def __init__(
        ...
        *,
        ...
        chat_instance: str,
        message: typing.Optional[typing.Optional["types.Message"]] = None,
        inline_message_id: typing.Optional[typing.Optional[str]] = None,
        data: Union[str, bytes] = None,
        game_short_name: typing.Optional[typing.Optional[str]] = None,
    ...
    async def answer(self, text: typing.Optional[typing.Optional[str]] = None, show_alert: typing.Optional[typing.Optional[bool]] = None, url: typing.Optional[typing.Optional[str]] = None, cache_time: int = 0):
