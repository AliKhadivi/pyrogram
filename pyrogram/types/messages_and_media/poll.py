...
class Poll(Object, Update):
    ...
    def __init__(
        ...
        *,
        ...
        total_voter_count: int,
        is_closed: bool,
        is_anonymous: typing.Optional[typing.Optional[bool]] = None,
        type: typing.Optional[typing.Optional["enums.PollType"]] = None,
        allows_multiple_answers: typing.Optional[typing.Optional[bool]] = None,
        chosen_option_id: typing.Optional[typing.Optional[Optional[int]]] = None,
        correct_option_id: typing.Optional[typing.Optional[Optional[int]]] = None,
        explanation: typing.Optional[typing.Optional[Optional[str]]] = None,
        explanation_entities: typing.Optional[typing.Optional[Optional[List["types.MessageEntity"]]]] = None,
        open_period: typing.Optional[typing.Optional[Optional[int]]] = None,
