...
class InlineQueryResultLocation(InlineQueryResult):
    ...
    def __init__(
        ...
        latitude: float,
        longitude: float,
        horizontal_accuracy: typing.Optional[typing.Optional[float]] = None,
        live_period: typing.Optional[typing.Optional[int]] = None,
        heading: typing.Optional[typing.Optional[int]] = None,
        proximity_alert_radius: typing.Optional[typing.Optional[int]] = None,
