...
class ChatInviteLink(Object):
    ...
    def __init__(
        ...
        invite_link: str,
        date: datetime,
        is_primary: typing.Optional[typing.Optional[bool]] = None,
        is_revoked: typing.Optional[typing.Optional[bool]] = None,
        creator: typing.Optional[typing.Optional["types.User"]] = None,
        name: typing.Optional[typing.Optional[str]] = None,
        creates_join_request: typing.Optional[typing.Optional[bool]] = None,
        ...
        member_count: typing.Optional[typing.Optional[int]] = None,
