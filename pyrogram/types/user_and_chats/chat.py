...
class Chat(Object):
    ...
    def __init__(
        ...
        *,
        ...
        is_creator: typing.Optional[typing.Optional[bool]] = None,
        ...
        invite_link: typing.Optional[typing.Optional[str]] = None,
        pinned_message=None,
        sticker_set_name: typing.Optional[typing.Optional[str]] = None,
        can_set_sticker_set: typing.Optional[typing.Optional[bool]] = None,
        members_count: typing.Optional[typing.Optional[int]] = None,
        restrictions: typing.Optional[typing.Optional[List["types.Restriction"]]] = None,
        permissions: typing.Optional[typing.Optional["types.ChatPermissions"]] = None,
        distance: typing.Optional[typing.Optional[int]] = None,
        linked_chat: typing.Optional[typing.Optional["types.Chat"]] = None,
        send_as_chat: typing.Optional[typing.Optional["types.Chat"]] = None,
