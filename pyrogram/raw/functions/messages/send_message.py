...
class SendMessage(TLObject["raw.base.Updates"]):
    ...
    def __init__(self, *, peer: "raw.base.InputPeer", message: str, random_id: int, no_webpage: Optional[bool] = None, silent: Optional[bool] = None, background: Optional[bool] = None, clear_draft: Optional[bool] = None, noforwards: Optional[bool] = None, update_stickersets_order: Optional[bool] = None, invert_media: Optional[bool] = None, allow_paid_floodskip: Optional[bool] = None, reply_to: Optional["raw.base.InputReplyTo"] = None, reply_markup: Optional["raw.base.ReplyMarkup"] = None, entities: Optional[List["raw.base.MessageEntity"]] = None, schedule_date: Optional[int] = None, schedule_repeat_period: Optional[int] = None, send_as: Optional["raw.base.InputPeer"] = None, quick_reply_shortcut: Optional["raw.base.InputQuickReplyShortcut"] = None, effect: Optional[int] = None, allow_paid_stars: Optional[int] = None, suggested_post: Optional["raw.base.SuggestedPost"] = None, rich_message: Optional["raw.base.InputRichMessage"] = None) -> None:
