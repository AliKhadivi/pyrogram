...
if TYPE_CHECKING:
    InputBusinessGreetingMessage = Any
else:
    InputBusinessGreetingMessage = Union[raw.types.InputBusinessGreetingMessage]

_doc = """Describes a Telegram Business greeting, automatically sent to new users writing to us in private for the first time, or after a certain inactivity period.
...
try:
    _t = type(InputBusinessGreetingMessage)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        InputBusinessGreetingMessage.__doc__ = _doc
