...
if TYPE_CHECKING:
    GroupCallMessage = Any
else:
    GroupCallMessage = Union[raw.types.GroupCallMessage]

_doc = """Represents an in-call message, emoji reaction », paid live story comment or standalone paid live story donation.
