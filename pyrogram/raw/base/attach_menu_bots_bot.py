...
if TYPE_CHECKING:
    AttachMenuBotsBot = Any
else:
    AttachMenuBotsBot = Union[raw.types.AttachMenuBotsBot]

_doc = """Represents a bot mini app that can be launched from the attachment menu »
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        AttachMenuBotsBot.__doc__ = _doc
