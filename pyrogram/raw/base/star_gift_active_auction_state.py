...
if TYPE_CHECKING:
    StarGiftActiveAuctionState = Any
else:
    StarGiftActiveAuctionState = Union[raw.types.StarGiftActiveAuctionState]

_doc = """Contains info about an auction where the user has placed a bid ».
...
try:
    _t = type(StarGiftActiveAuctionState)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        StarGiftActiveAuctionState.__doc__ = _doc
