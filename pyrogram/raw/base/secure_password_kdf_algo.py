...
_doc = """KDF algorithm to use for computing telegram passport hash
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        SecurePasswordKdfAlgo.__doc__ = _doc
