...
if TYPE_CHECKING:
    BusinessChatLink = Any
else:
    BusinessChatLink = Union[raw.types.BusinessChatLink]

_doc = """Contains info about a business chat deep link » created by the current account.
