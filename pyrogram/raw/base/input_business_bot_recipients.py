...
if TYPE_CHECKING:
    InputBusinessBotRecipients = Any
else:
    InputBusinessBotRecipients = Union[raw.types.InputBusinessBotRecipients]

_doc = """Specifies the private chats that a connected business bot » may interact with.
...
try:
    _t = type(InputBusinessBotRecipients)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        InputBusinessBotRecipients.__doc__ = _doc
