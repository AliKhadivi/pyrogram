...
_doc = """This constructor allows setting a custom background color and custom emoji label for a button, see here » for more info.
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        KeyboardButtonStyle.__doc__ = _doc
