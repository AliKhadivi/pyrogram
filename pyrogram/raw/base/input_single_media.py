...
if TYPE_CHECKING:
    InputSingleMedia = Any
else:
    InputSingleMedia = Union[raw.types.InputSingleMedia]

_doc = """A single media in an album or grouped media sent with messages.sendMultiMedia.
