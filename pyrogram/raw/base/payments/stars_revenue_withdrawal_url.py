...
if TYPE_CHECKING:
    StarsRevenueWithdrawalUrl = Any
else:
    StarsRevenueWithdrawalUrl = Union[raw.types.payments.StarsRevenueWithdrawalUrl]

_doc = """Contains the URL to use to withdraw Telegram Star revenue.
...
try:
    _t = type(StarsRevenueWithdrawalUrl)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        StarsRevenueWithdrawalUrl.__doc__ = _doc
