...
_doc = """List of currently active gift auctions » where the user has placed a bid, or an indication that the locally cached list hasn't changed.
...
try:
    _t = type(StarGiftActiveAuctions)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        StarGiftActiveAuctions.__doc__ = _doc
