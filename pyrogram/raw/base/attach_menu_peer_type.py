...
_doc = """Indicates a supported peer type for a bot mini app attachment menu
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        AttachMenuPeerType.__doc__ = _doc
