...
if TYPE_CHECKING:
    ParticipantJoinedChats = Any
else:
    ParticipantJoinedChats = Union[raw.types.communities.ParticipantJoinedChats]
...
try:
    _t = type(ParticipantJoinedChats)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        ParticipantJoinedChats.__doc__ = _doc
