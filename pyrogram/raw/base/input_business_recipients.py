...
if TYPE_CHECKING:
    InputBusinessRecipients = Any
else:
    InputBusinessRecipients = Union[raw.types.InputBusinessRecipients]

_doc = """Specifies the chats that can receive Telegram Business away » and greeting » messages.
...
try:
    _t = type(InputBusinessRecipients)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        InputBusinessRecipients.__doc__ = _doc
