...
if TYPE_CHECKING:
    InlineBotWebView = Any
else:
    InlineBotWebView = Union[raw.types.InlineBotWebView]

_doc = """Specifies an inline mode mini app button, shown on top of the inline query results list.
