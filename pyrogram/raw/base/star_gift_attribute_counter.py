...
if TYPE_CHECKING:
    StarGiftAttributeCounter = Any
else:
    StarGiftAttributeCounter = Union[raw.types.StarGiftAttributeCounter]

_doc = """Indicates the total number of gifts that have the specified attribute.
...
try:
    _t = type(StarGiftAttributeCounter)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        StarGiftAttributeCounter.__doc__ = _doc
