...
if TYPE_CHECKING:
    ReactionsNotifySettings = Any
else:
    ReactionsNotifySettings = Union[raw.types.ReactionsNotifySettings]

_doc = """Reaction notification settings, see here » for more info.
...
try:
    _t = type(ReactionsNotifySettings)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        ReactionsNotifySettings.__doc__ = _doc
