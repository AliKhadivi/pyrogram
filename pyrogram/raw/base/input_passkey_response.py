...
if TYPE_CHECKING:
    InputPasskeyResponse = Any
else:
    InputPasskeyResponse = Union[raw.types.InputPasskeyResponseLogin, raw.types.InputPasskeyResponseRegister]

_doc = """WebAuthn response generated by the authenticator when registering or logging in with a public-key passkey ».
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        InputPasskeyResponse.__doc__ = _doc
