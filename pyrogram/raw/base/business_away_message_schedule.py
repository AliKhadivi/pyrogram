...
if TYPE_CHECKING:
    BusinessAwayMessageSchedule = Any
else:
...
_doc = """Specifies when should the Telegram Business away messages be sent.
...
try:
    _t = type(BusinessAwayMessageSchedule)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        BusinessAwayMessageSchedule.__doc__ = _doc
