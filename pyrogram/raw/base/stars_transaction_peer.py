...
_doc = """Source of an incoming Telegram Star transaction, or its recipient for outgoing Telegram Star transactions.
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        StarsTransactionPeer.__doc__ = _doc
