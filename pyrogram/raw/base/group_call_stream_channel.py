...
if TYPE_CHECKING:
    GroupCallStreamChannel = Any
else:
    GroupCallStreamChannel = Union[raw.types.GroupCallStreamChannel]

_doc = """Info about an RTMP stream in a group call or livestream
...
try:
    _t = type(GroupCallStreamChannel)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        GroupCallStreamChannel.__doc__ = _doc
