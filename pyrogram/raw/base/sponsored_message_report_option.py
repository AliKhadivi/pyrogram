...
if TYPE_CHECKING:
    SponsoredMessageReportOption = Any
else:
    SponsoredMessageReportOption = Union[raw.types.SponsoredMessageReportOption]

_doc = """A report option for a sponsored message ».
...
try:
    _t = type(SponsoredMessageReportOption)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        SponsoredMessageReportOption.__doc__ = _doc
