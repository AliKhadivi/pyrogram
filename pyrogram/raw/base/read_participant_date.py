...
if TYPE_CHECKING:
    ReadParticipantDate = Any
else:
    ReadParticipantDate = Union[raw.types.ReadParticipantDate]

_doc = """Contains info about when a certain participant has read a message
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        ReadParticipantDate.__doc__ = _doc
