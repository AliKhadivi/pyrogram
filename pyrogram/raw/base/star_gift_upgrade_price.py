...
if TYPE_CHECKING:
    StarGiftUpgradePrice = Any
else:
    StarGiftUpgradePrice = Union[raw.types.StarGiftUpgradePrice]

_doc = """Indicates the price for a gift upgrade » starting from a specific point in time.
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        StarGiftUpgradePrice.__doc__ = _doc
