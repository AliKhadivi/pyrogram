...
if TYPE_CHECKING:
    TranslatedRichMessage = Any
else:
    TranslatedRichMessage = Union[raw.types.messages.TranslatedRichMessage]
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        TranslatedRichMessage.__doc__ = _doc
