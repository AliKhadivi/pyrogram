...
if TYPE_CHECKING:
    PreparedInlineMessage = Any
else:
    PreparedInlineMessage = Union[raw.types.messages.PreparedInlineMessage]

_doc = """Represents a prepared inline message received via a bot's mini app, that can be sent to some chats »
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        PreparedInlineMessage.__doc__ = _doc
