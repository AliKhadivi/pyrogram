...
if TYPE_CHECKING:
    HistoryImportParsed = Any
else:
    HistoryImportParsed = Union[raw.types.messages.HistoryImportParsed]

_doc = """Contains information about a chat export file, generated by a foreign chat app.
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        HistoryImportParsed.__doc__ = _doc
