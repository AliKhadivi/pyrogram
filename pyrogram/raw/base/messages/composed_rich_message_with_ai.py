...
if TYPE_CHECKING:
    ComposedRichMessageWithAI = Any
else:
    ComposedRichMessageWithAI = Union[raw.types.messages.ComposedRichMessageWithAI]

_doc = """Telegram API base type.
...
try:
    _t = type(ComposedRichMessageWithAI)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        ComposedRichMessageWithAI.__doc__ = _doc
