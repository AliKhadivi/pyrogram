...
if TYPE_CHECKING:
    ExportedChatInvite = Any
else:
    ExportedChatInvite = Union[raw.types.messages.ExportedChatInvite, raw.types.messages.ExportedChatInviteReplaced]

_doc = """Contains info about a chat invite, and eventually a pointer to the newest chat invite.
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        ExportedChatInvite.__doc__ = _doc
