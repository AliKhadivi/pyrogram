...
if TYPE_CHECKING:
    MediaAreaCoordinates = Any
else:
    MediaAreaCoordinates = Union[raw.types.MediaAreaCoordinates]

_doc = """Coordinates and size of a clickable rectangular area on top of a story.
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        MediaAreaCoordinates.__doc__ = _doc
