...
_doc = """Various possible attributes of a document (used to define if it's a sticker, a GIF, a video, a mask sticker, an image, an audio, and so on)
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        DocumentAttribute.__doc__ = _doc
