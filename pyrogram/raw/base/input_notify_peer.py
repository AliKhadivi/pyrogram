...
if TYPE_CHECKING:
    ...
    InputNotifyPeer = Union[raw.types.InputNotifyBroadcasts, raw.types.InputNotifyChats, raw.types.InputNotifyCommunity, raw.types.InputNotifyForumTopic, raw.types.InputNotifyPeer, raw.types.InputNotifyUsers]

_doc = """Object defines the set of users and/or groups that generate notifications.
