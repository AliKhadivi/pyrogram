...
if TYPE_CHECKING:
    BusinessChatLinks = Any
else:
    BusinessChatLinks = Union[raw.types.account.BusinessChatLinks]

_doc = """Contains info about business chat deep links » created by the current account.
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        BusinessChatLinks.__doc__ = _doc
