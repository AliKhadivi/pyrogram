...
if TYPE_CHECKING:
    ResolvedBusinessChatLinks = Any
else:
    ResolvedBusinessChatLinks = Union[raw.types.account.ResolvedBusinessChatLinks]

_doc = """Contains info about a single resolved business chat deep link ».
...
try:
    _t = type(ResolvedBusinessChatLinks)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        ResolvedBusinessChatLinks.__doc__ = _doc
