...
if TYPE_CHECKING:
    SponsoredMessageReportResult = Any
else:
...
_doc = """Status of the method call used to report a sponsored message ».
...
try:
    _t = type(SponsoredMessageReportResult)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        SponsoredMessageReportResult.__doc__ = _doc
