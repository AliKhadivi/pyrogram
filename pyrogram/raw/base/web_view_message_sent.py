...
if TYPE_CHECKING:
    WebViewMessageSent = Any
else:
    WebViewMessageSent = Union[raw.types.WebViewMessageSent]

_doc = """Contains information about an inline message sent by a Web App on behalf of a user.
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        WebViewMessageSent.__doc__ = _doc
