...
if TYPE_CHECKING:
    InputMessageReadMetric = Any
else:
    InputMessageReadMetric = Union[raw.types.InputMessageReadMetric]

_doc = """Read metric for a single message exposure, describing how long the message was visible in the chat viewport.
...
try:
    _t = type(InputMessageReadMetric)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        InputMessageReadMetric.__doc__ = _doc
