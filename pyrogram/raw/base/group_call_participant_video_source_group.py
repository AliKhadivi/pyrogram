...
if TYPE_CHECKING:
    GroupCallParticipantVideoSourceGroup = Any
else:
    GroupCallParticipantVideoSourceGroup = Union[raw.types.GroupCallParticipantVideoSourceGroup]

_doc = """Describes a group of video synchronization source identifiers
...
try:
    _t = type(GroupCallParticipantVideoSourceGroup)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        GroupCallParticipantVideoSourceGroup.__doc__ = _doc
