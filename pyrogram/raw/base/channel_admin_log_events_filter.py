...
if TYPE_CHECKING:
    ChannelAdminLogEventsFilter = Any
else:
    ChannelAdminLogEventsFilter = Union[raw.types.ChannelAdminLogEventsFilter]

_doc = """Filter for fetching events in the channel admin log
...
try:
    _t = type(ChannelAdminLogEventsFilter)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        ChannelAdminLogEventsFilter.__doc__ = _doc
