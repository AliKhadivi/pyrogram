...
if TYPE_CHECKING:
    ...
    InputReplyTo = Union[raw.types.InputReplyToEphemeralMessage, raw.types.InputReplyToMessage, raw.types.InputReplyToMonoForum, raw.types.InputReplyToStory]

_doc = """Contains info about a message or story to reply to.
