...
if TYPE_CHECKING:
    SearchResultsCalendarPeriod = Any
else:
    SearchResultsCalendarPeriod = Union[raw.types.SearchResultsCalendarPeriod]

_doc = """Information about found messages sent on a specific day, used to split the messages in messages.searchResultsCalendar constructors by days.
...
try:
    _t = type(SearchResultsCalendarPeriod)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        SearchResultsCalendarPeriod.__doc__ = _doc
