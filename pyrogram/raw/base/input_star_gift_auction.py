...
if TYPE_CHECKING:
    InputStarGiftAuction = Any
else:
    InputStarGiftAuction = Union[raw.types.InputStarGiftAuction, raw.types.InputStarGiftAuctionSlug]

_doc = """Identifies a collectible gift auction », either by the ID of the linked collectible gift or by an auction deep link slug.
...
try:
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        InputStarGiftAuction.__doc__ = _doc
