...
if TYPE_CHECKING:
    InputWebDocument = Any
else:
    InputWebDocument = Union[raw.types.InputWebDocument]

_doc = """Specifies a document that will have to be downloaded from the URL by the telegram servers
