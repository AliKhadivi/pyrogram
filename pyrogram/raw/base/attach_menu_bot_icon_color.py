...
if TYPE_CHECKING:
    AttachMenuBotIconColor = Any
else:
    AttachMenuBotIconColor = Union[raw.types.AttachMenuBotIconColor]

_doc = """Represents an attachment menu icon color for bot mini apps »
...
try:
    _t = type(AttachMenuBotIconColor)
    ...
    if _module != "typing" and not (_module == "types" and _name == "UnionType"):
        AttachMenuBotIconColor.__doc__ = _doc
