...
class RecentStory(TLObject):
    ...
    Parameters:
        live (``bool``, *optional*):
            Whether the peer is currently broadcasting a live story ».

        max_id (``int`` ``32-bit``, *optional*):
            If live is set, ID of the peer's active live story »; otherwise, ID of the peer's maximum active story.
