...
class UserFull(TLObject):
    ...
    Parameters:
        ...
        bot_manager_id (``int`` ``64-bit``, *optional*):
            If this user is a managed bot », the ID of the user or manager bot that manages it.
    ...
    def __init__(self, *, id: int, settings: "raw.base.PeerSettings", notify_settings: "raw.base.PeerNotifySettings", common_chats_count: int, blocked: Optional[bool] = None, phone_calls_available: Optional[bool] = None, phone_calls_private: Optional[bool] = None, can_pin_message: Optional[bool] = None, has_scheduled: Optional[bool] = None, video_calls_available: Optional[bool] = None, voice_messages_forbidden: Optional[bool] = None, translations_disabled: Optional[bool] = None, stories_pinned_available: Optional[bool] = None, blocked_my_stories_from: Optional[bool] = None, wallpaper_overridden: Optional[bool] = None, contact_require_premium: Optional[bool] = None, read_dates_private: Optional[bool] = None, sponsored_enabled: Optional[bool] = None, can_view_revenue: Optional[bool] = None, bot_can_manage_emoji_status: Optional[bool] = None, display_gifts_button: Optional[bool] = None, noforwards_my_enabled: Optional[bool] = None, noforwards_peer_enabled: Optional[bool] = None, unofficial_security_risk: Optional[bool] = None, about: Optional[str] = None, personal_photo: Optional["raw.base.Photo"] = None, profile_photo: Optional["raw.base.Photo"] = None, fallback_photo: Optional["raw.base.Photo"] = None, bot_info: Optional["raw.base.BotInfo"] = None, pinned_msg_id: Optional[int] = None, folder_id: Optional[int] = None, ttl_period: Optional[int] = None, theme: Optional["raw.base.ChatTheme"] = None, private_forward_name: Optional[str] = None, bot_group_admin_rights: Optional["raw.base.ChatAdminRights"] = None, bot_broadcast_admin_rights: Optional["raw.base.ChatAdminRights"] = None, wallpaper: Optional["raw.base.WallPaper"] = None, stories: Optional["raw.base.PeerStories"] = None, business_work_hours: Optional["raw.base.BusinessWorkHours"] = None, business_location: Optional["raw.base.BusinessLocation"] = None, business_greeting_message: Optional["raw.base.BusinessGreetingMessage"] = None, business_away_message: Optional["raw.base.BusinessAwayMessage"] = None, business_intro: Optional["raw.base.BusinessIntro"] = None, birthday: Optional["raw.base.Birthday"] = None, personal_channel_id: Optional[int] = None, personal_channel_message: Optional[int] = None, stargifts_count: Optional[int] = None, starref_program: Optional["raw.base.StarRefProgram"] = None, bot_verification: Optional["raw.base.BotVerification"] = None, send_paid_messages_stars: Optional[int] = None, disallowed_gifts: Optional["raw.base.DisallowedGiftsSettings"] = None, stars_rating: Optional["raw.base.StarsRating"] = None, stars_my_pending_rating: Optional["raw.base.StarsRating"] = None, stars_my_pending_rating_date: Optional[int] = None, main_tab: Optional["raw.base.ProfileTab"] = None, saved_music: Optional["raw.base.Document"] = None, note: Optional["raw.base.TextWithEntities"] = None, bot_manager_id: Optional[int] = None) -> None:
        self.id = id  # long
