...
class StarsTransaction(TLObject):
    ...
    Parameters:
        ...
        stargift_drop_original_details (``bool``, *optional*):
            Represents payment for the removal of the starGiftAttributeOriginalDetails attribute from a gift, see here » for the full flow.

        phonegroup_message (``bool``, *optional*):
            Represents payment for a paid text message sent during a group call or live video stream ».
