...
class StarGiftUnique(TLObject):
    ...
    Parameters:
        ...
        gift_id (``int`` ``64-bit``):
            ID of the regular gift from which this gift was upgraded (all collectible gifts upgraded from the same gift will have the same gift_id, with different attributes).
        ...
        resale_ton_only (``bool``, *optional*):
            Whether the gift can be bought only using Grams.
        ...
        host_id (:obj:`Peer <pyrogram.raw.base.Peer>`, *optional*):
            If set, the gift is currently hosted on the specified user or channel profile », while ownership remains with the TON wallet in owner_address.

        offer_min_stars (``int`` ``32-bit``, *optional*):
            If set, you can send a purchase offer for this gift »: the minimum offer price is specified in this flag.
    ...
    def __init__(self, *, id: int, gift_id: int, title: str, slug: str, num: int, attributes: List["raw.base.StarGiftAttribute"], availability_issued: int, availability_total: int, require_premium: Optional[bool] = None, resale_ton_only: Optional[bool] = None, theme_available: Optional[bool] = None, burned: Optional[bool] = None, crafted: Optional[bool] = None, owner_id: Optional["raw.base.Peer"] = None, owner_name: Optional[str] = None, owner_address: Optional[str] = None, gift_address: Optional[str] = None, resell_amount: Optional[List["raw.base.StarsAmount"]] = None, released_by: Optional["raw.base.Peer"] = None, value_amount: Optional[int] = None, value_currency: Optional[str] = None, value_usd_amount: Optional[int] = None, theme_peer: Optional["raw.base.Peer"] = None, peer_color: Optional["raw.base.PeerColor"] = None, host_id: Optional["raw.base.Peer"] = None, offer_min_stars: Optional[int] = None, craft_chance_permille: Optional[int] = None) -> None:
        self.id = id  # long
