...
class User(TLObject):
    ...
    Parameters:
        ...
        bot_forum_can_manage_topics (``bool``, *optional*):
            If set, this bot supports bot forum topics », and users (not just the bot!) are allowed to create and manage bot forum topics in their private chat with the bot.

        bot_can_manage_bots (``bool``, *optional*):
            If set, this bot is a manager bot that can create and manage managed bots » on behalf of the user.

        bot_guestchat (``bool``, *optional*):
            If set, this bot can be invoked as a guest in chats ».
        ...
        stories_max_id (:obj:`RecentStory <pyrogram.raw.base.RecentStory>`, *optional*):
            Summary of the user's active stories ».  When updating the local peer database, do not apply changes to this field if the min flag of the incoming constructor is set.
        ...
        linked_community_id (``int`` ``64-bit``, *optional*):
            N/A
    ...
    def __init__(self, *, id: int, is_self: Optional[bool] = None, contact: Optional[bool] = None, mutual_contact: Optional[bool] = None, deleted: Optional[bool] = None, bot: Optional[bool] = None, bot_chat_history: Optional[bool] = None, bot_nochats: Optional[bool] = None, verified: Optional[bool] = None, restricted: Optional[bool] = None, min: Optional[bool] = None, bot_inline_geo: Optional[bool] = None, support: Optional[bool] = None, scam: Optional[bool] = None, apply_min_photo: Optional[bool] = None, fake: Optional[bool] = None, bot_attach_menu: Optional[bool] = None, premium: Optional[bool] = None, attach_menu_enabled: Optional[bool] = None, bot_can_edit: Optional[bool] = None, close_friend: Optional[bool] = None, stories_hidden: Optional[bool] = None, stories_unavailable: Optional[bool] = None, contact_require_premium: Optional[bool] = None, bot_business: Optional[bool] = None, bot_has_main_app: Optional[bool] = None, bot_forum_view: Optional[bool] = None, bot_forum_can_manage_topics: Optional[bool] = None, bot_can_manage_bots: Optional[bool] = None, bot_guestchat: Optional[bool] = None, bot_guard: Optional[bool] = None, access_hash: Optional[int] = None, first_name: Optional[str] = None, last_name: Optional[str] = None, username: Optional[str] = None, phone: Optional[str] = None, photo: Optional["raw.base.UserProfilePhoto"] = None, status: Optional["raw.base.UserStatus"] = None, bot_info_version: Optional[int] = None, restriction_reason: Optional[List["raw.base.RestrictionReason"]] = None, bot_inline_placeholder: Optional[str] = None, lang_code: Optional[str] = None, emoji_status: Optional["raw.base.EmojiStatus"] = None, usernames: Optional[List["raw.base.Username"]] = None, stories_max_id: Optional["raw.base.RecentStory"] = None, color: Optional["raw.base.PeerColor"] = None, profile_color: Optional["raw.base.PeerColor"] = None, bot_active_users: Optional[int] = None, bot_verification_icon: Optional[int] = None, send_paid_messages_stars: Optional[int] = None, linked_community_id: Optional[int] = None) -> None:
        ...
        self.linked_community_id = linked_community_id  # flags2.21?long
    ...
    def write(self, *args) -> bytes:
        ...
        flags2 |= (1 << 21) if self.linked_community_id is not None else 0
        b.write(Int(flags2))
        ...
        if self.linked_community_id is not None:
            b.write(Long(self.linked_community_id))
