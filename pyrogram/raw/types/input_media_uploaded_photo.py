...
class InputMediaUploadedPhoto(TLObject):
    ...
    Parameters:
        ...
        ttl_seconds (``int`` ``32-bit``, *optional*):
            Time to live of self-destructing photo, can be 0 to disable self-destruction, 0x7FFFFFFF to self-destruct the photo immediately after it's played; otherwise self-destructs ttl_seconds after it's played.
