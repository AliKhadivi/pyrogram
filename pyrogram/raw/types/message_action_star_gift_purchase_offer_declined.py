...
class MessageActionStarGiftPurchaseOfferDeclined(TLObject):
    ...
    Parameters:
        ...
        expired (``bool``, *optional*):
            If set, the owner didn't act before the messageActionStarGiftPurchaseOffer.expires_at deadline and the offer expired automatically; otherwise, the owner explicitly declined the offer.
