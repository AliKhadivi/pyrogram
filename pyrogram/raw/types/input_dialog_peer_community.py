...
class InputDialogPeerCommunity(TLObject):
    ...
    __slots__: List[str] = ["community"]

    ID = 0x69ef72c4
    QUALNAME = "types.InputDialogPeerCommunity"

    def __init__(self, *, community: "raw.base.InputChannel") -> None:
        self.community = community  # InputChannel

    @staticmethod
    def read(b: BytesIO, *args: Any) -> "InputDialogPeerCommunity":
        # No flags
