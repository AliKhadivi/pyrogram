...
class ComposedMessageWithAI(TLObject):
    ...
    Parameters:
        ...
        diff_text (:obj:`TextWithEntities <pyrogram.raw.base.TextWithEntities>`, *optional*):
            If only the proofreading mode (messages.composeMessageWithAI.proofread) is enabled, this field will be populated with a "pre-rendered" diff between the old and the new message text using only diff entities ».
