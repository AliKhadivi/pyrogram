...
class Channel(TLObject):
    ...
    Parameters:
        ...
        stories_max_id (:obj:`RecentStory <pyrogram.raw.base.RecentStory>`, *optional*):
            Summary of the channel or supergroup's active stories ».
    ...
    def __init__(self, *, id: int, title: str, photo: "raw.base.ChatPhoto", date: int, creator: Optional[bool] = None, left: Optional[bool] = None, broadcast: Optional[bool] = None, verified: Optional[bool] = None, megagroup: Optional[bool] = None, restricted: Optional[bool] = None, signatures: Optional[bool] = None, min: Optional[bool] = None, scam: Optional[bool] = None, has_link: Optional[bool] = None, has_geo: Optional[bool] = None, slowmode_enabled: Optional[bool] = None, call_active: Optional[bool] = None, call_not_empty: Optional[bool] = None, fake: Optional[bool] = None, gigagroup: Optional[bool] = None, noforwards: Optional[bool] = None, join_to_send: Optional[bool] = None, join_request: Optional[bool] = None, forum: Optional[bool] = None, stories_hidden: Optional[bool] = None, stories_hidden_min: Optional[bool] = None, stories_unavailable: Optional[bool] = None, signature_profiles: Optional[bool] = None, autotranslation: Optional[bool] = None, broadcast_messages_allowed: Optional[bool] = None, monoforum: Optional[bool] = None, forum_tabs: Optional[bool] = None, access_hash: Optional[int] = None, username: Optional[str] = None, restriction_reason: Optional[List["raw.base.RestrictionReason"]] = None, admin_rights: Optional["raw.base.ChatAdminRights"] = None, banned_rights: Optional["raw.base.ChatBannedRights"] = None, default_banned_rights: Optional["raw.base.ChatBannedRights"] = None, participants_count: Optional[int] = None, usernames: Optional[List["raw.base.Username"]] = None, stories_max_id: Optional["raw.base.RecentStory"] = None, color: Optional["raw.base.PeerColor"] = None, profile_color: Optional["raw.base.PeerColor"] = None, emoji_status: Optional["raw.base.EmojiStatus"] = None, level: Optional[int] = None, subscription_until_date: Optional[int] = None, bot_verification_icon: Optional[int] = None, send_paid_messages_stars: Optional[int] = None, linked_monoforum_id: Optional[int] = None, linked_community_id: Optional[int] = None) -> None:
        ...
        self.linked_community_id = linked_community_id  # flags2.20?long
    ...
    def write(self, *args) -> bytes:
        ...
        flags2 |= (1 << 20) if self.linked_community_id is not None else 0
        b.write(Int(flags2))
