...
class AccessSettings(TLObject):
    ...
    Parameters:
        restricted (``bool``, *optional*):
            If set, only the owner and the users in add_users can access the managed bot

        add_users (List of :obj:`User <pyrogram.raw.base.User>`, *optional*):
            Additional users (max 10, excluding the owner) who can access the managed bot; only present when restricted is set
