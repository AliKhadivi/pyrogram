...
class ChatFull(TLObject):
    ...
    Parameters:
        ...
        call (:obj:`InputGroupCall <pyrogram.raw.base.InputGroupCall>`, *optional*):
            Active or scheduled video chat » associated with this basic group
        ...
        groupcall_default_join_as (:obj:`Peer <pyrogram.raw.base.Peer>`, *optional*):
            Explicitly saved default peer used to join this group's video chat »; if absent, the current user is used
    ...
    def __init__(self, *, id: int, about: str, participants: "raw.base.ChatParticipants", notify_settings: "raw.base.PeerNotifySettings", can_set_username: Optional[bool] = None, has_scheduled: Optional[bool] = None, translations_disabled: Optional[bool] = None, chat_photo: Optional["raw.base.Photo"] = None, exported_invite: Optional["raw.base.ExportedChatInvite"] = None, bot_info: Optional[List["raw.base.BotInfo"]] = None, pinned_msg_id: Optional[int] = None, folder_id: Optional[int] = None, call: Optional["raw.base.InputGroupCall"] = None, ttl_period: Optional[int] = None, groupcall_default_join_as: Optional["raw.base.Peer"] = None, theme_emoticon: Optional[str] = None, requests_pending: Optional[int] = None, recent_requesters: Optional[List[int]] = None, available_reactions: Optional["raw.base.ChatReactions"] = None, reactions_limit: Optional[int] = None) -> None:
        self.id = id  # long
