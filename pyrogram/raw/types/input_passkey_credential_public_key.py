...
class InputPasskeyCredentialPublicKey(TLObject):
    ...
    Parameters:
        id (``str``):
            id field of a PublicKeyCredential, passed as-is without base64url-decoding when using the JSON representation

        raw_id (``str``):
            rawId field of a PublicKeyCredential, passed as-is without base64url-decoding when using the JSON representation
