...
class UpdateGroupCallConnection(TLObject):
    ...
    Parameters:
        params (:obj:`DataJSON <pyrogram.raw.base.DataJSON>`):
            RTC join response parameters or broadcast-stream metadata, as described above

        presentation (``bool``, *optional*):
            Whether these parameters belong to the separate presentation connection instead of the main connection
