...
class Message(TLObject):
    ...
    Parameters:
        ...
        media_unread (``bool``, *optional*):
            Whether there are unread media attachments in this message, see here » for more info on how to clear this flag.
        ...
        paid_suggested_post_ton (``bool``, *optional*):
            Set if this is a suggested channel post » that was paid using Grams.
        ...
        from_rank (``str``, *optional*):
            Only in supergroups » (never basic groups, where this information is contained elsewhere »), contains the sender's tag ».
        ...
        summary_from_language (``str``, *optional*):
            If set, clients should offer a summarization button » for this message; contains the two-letter ISO 639-1 language code of the inferred language of the current message.
    ...
    def __init__(self, *, id: int, peer_id: "raw.base.Peer", date: int, message: str, out: Optional[bool] = None, mentioned: Optional[bool] = None, media_unread: Optional[bool] = None, silent: Optional[bool] = None, post: Optional[bool] = None, from_scheduled: Optional[bool] = None, legacy: Optional[bool] = None, edit_hide: Optional[bool] = None, pinned: Optional[bool] = None, noforwards: Optional[bool] = None, invert_media: Optional[bool] = None, offline: Optional[bool] = None, video_processing_pending: Optional[bool] = None, paid_suggested_post_stars: Optional[bool] = None, paid_suggested_post_ton: Optional[bool] = None, from_id: Optional["raw.base.Peer"] = None, from_boosts_applied: Optional[int] = None, from_rank: Optional[str] = None, saved_peer_id: Optional["raw.base.Peer"] = None, fwd_from: Optional["raw.base.MessageFwdHeader"] = None, via_bot_id: Optional[int] = None, via_business_bot_id: Optional[int] = None, guestchat_via_from: Optional["raw.base.Peer"] = None, reply_to: Optional["raw.base.MessageReplyHeader"] = None, media: Optional["raw.base.MessageMedia"] = None, reply_markup: Optional["raw.base.ReplyMarkup"] = None, entities: Optional[List["raw.base.MessageEntity"]] = None, views: Optional[int] = None, forwards: Optional[int] = None, replies: Optional["raw.base.MessageReplies"] = None, edit_date: Optional[int] = None, post_author: Optional[str] = None, grouped_id: Optional[int] = None, reactions: Optional["raw.base.MessageReactions"] = None, restriction_reason: Optional[List["raw.base.RestrictionReason"]] = None, ttl_period: Optional[int] = None, quick_reply_shortcut_id: Optional[int] = None, effect: Optional[int] = None, factcheck: Optional["raw.base.FactCheck"] = None, report_delivery_until_date: Optional[int] = None, paid_message_stars: Optional[int] = None, suggested_post: Optional["raw.base.SuggestedPost"] = None, schedule_repeat_period: Optional[int] = None, summary_from_language: Optional[str] = None, rich_message: Optional["raw.base.RichMessage"] = None) -> None:
        self.id = id  # int
