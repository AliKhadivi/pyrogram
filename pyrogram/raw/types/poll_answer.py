...
class PollAnswer(TLObject):
    ...
    Parameters:
        ...
        media (:obj:`MessageMedia <pyrogram.raw.base.MessageMedia>`, *optional*):
            Optional media attachment displayed alongside the answer

        added_by (:obj:`Peer <pyrogram.raw.base.Peer>`, *optional*):
            The peer who added this answer; only set for answers dynamically added to an open-answer poll, see polls »

        date (``int`` ``32-bit``, *optional*):
            When this answer was added; only set for answers dynamically added to an open-answer poll
