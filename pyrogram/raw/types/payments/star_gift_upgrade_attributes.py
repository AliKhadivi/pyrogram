...
class StarGiftUpgradeAttributes(TLObject):
    ...
    Parameters:
        attributes (List of :obj:`StarGiftAttribute <pyrogram.raw.base.StarGiftAttribute>`):
            Full list of possible attributes that may be assigned when gifts of the specified type are turned into collectible gifts », including craft-only models marked with starGiftAttributeModel.crafted.
