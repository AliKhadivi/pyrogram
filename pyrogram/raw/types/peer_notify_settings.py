...
class PeerNotifySettings(TLObject):
    ...
    def __init__(self, *, show_previews: Optional[bool] = None, silent: Optional[bool] = None, mute_until: Optional[int] = None, ios_sound: Optional["raw.base.NotificationSound"] = None, android_sound: Optional["raw.base.NotificationSound"] = None, other_sound: Optional["raw.base.NotificationSound"] = None, stories_muted: Optional[bool] = None, stories_hide_sender: Optional[bool] = None, stories_ios_sound: Optional["raw.base.NotificationSound"] = None, stories_android_sound: Optional["raw.base.NotificationSound"] = None, stories_other_sound: Optional["raw.base.NotificationSound"] = None) -> None:
