...
class InputMediaPhoto(TLObject):
    ...
    Parameters:
        ...
        live_photo (``bool``, *optional*):
            Whether this is a live photo, i.e. a still photo paired with the short video clip captured alongside it

        ttl_seconds (``int`` ``32-bit``, *optional*):
            Time to live of self-destructing photo, can be 0 to disable self-destruction, 0x7FFFFFFF to self-destruct the document immediately after it's played; otherwise self-destructs ttl_seconds after it's played.

        video (:obj:`InputDocument <pyrogram.raw.base.InputDocument>`, *optional*):
            The short video clip of the live photo
    ...
    def __init__(self, *, id: "raw.base.InputPhoto", spoiler: Optional[bool] = None, live_photo: Optional[bool] = None, ttl_seconds: Optional[int] = None, video: Optional["raw.base.InputDocument"] = None) -> None:
