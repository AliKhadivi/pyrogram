...
class ForumTopic(TLObject):
    ...
    Parameters:
        ...
        peer (:obj:`Peer <pyrogram.raw.base.Peer>`):
            Contains the supergroup/private chat where the topic is located.  This field is useful especially when this object is returned by methods like messages.getMessages, which can return messages and forum topics belonging to different (private chat) peers in the same method call, making it impossible to tell the topic's peer based on the method call parameters or surrounding context.
        ...
        unread_poll_votes_count (``int`` ``32-bit``):
            Number of unread votes cast in non-anonymous polls » owned by the user in this forum topic.
