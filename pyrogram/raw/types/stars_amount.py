...
class StarsAmount(TLObject):
    ...
    Parameters:
        ...
        nanos (``int`` ``32-bit``):
            The decimal amount of Telegram Stars, expressed as nanostars (i.e. 1 nanostar is equal to 1/1_000_000_000th (one billionth) of a Telegram Star). This field may also be negative (the allowed range is from -999_999_999 to 999_999_999).
