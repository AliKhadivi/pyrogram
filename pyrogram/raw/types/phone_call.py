...
class PhoneCall(TLObject):
    ...
    Parameters:
        ...
        conference_supported (``bool``, *optional*):
            If set, the other party supports migrating the call to a conference call »; clients should only offer the migrate/"Add participants" option in the call UI when this flag is set.
