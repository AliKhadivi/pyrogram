...
class StarGiftAuctionStateFinished(TLObject):
    ...
    Parameters:
        ...
        listed_count (``int`` ``32-bit``, *optional*):
            Number of gifts from the auction currently being resold on Telegram: if set, when the corresponding element is clicked in graphical clients, payments.getResaleStarGifts should be invoked with the ID of the gift associated to this auction, see here » for more info.
        ...
        fragment_listed_url (``str``, *optional*):
            Only set if fragment_listed_count is set. If set, when the corresponding element is clicked in graphical clients, this URL should be opened.
