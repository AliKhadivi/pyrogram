...
class ChannelFull(TLObject):
    ...
    Parameters:
        ...
        call (:obj:`InputGroupCall <pyrogram.raw.base.InputGroupCall>`, *optional*):
            Active or scheduled video chat/livestream » associated with this supergroup/channel
        ...
        groupcall_default_join_as (:obj:`Peer <pyrogram.raw.base.Peer>`, *optional*):
            Explicitly saved default peer used to join this supergroup/channel's video chat/livestream »; if absent, the current user is used
    ...
    def __init__(self, *, id: int, about: str, read_inbox_max_id: int, read_outbox_max_id: int, unread_count: int, chat_photo: "raw.base.Photo", notify_settings: "raw.base.PeerNotifySettings", bot_info: List["raw.base.BotInfo"], pts: int, can_view_participants: Optional[bool] = None, can_set_username: Optional[bool] = None, can_set_stickers: Optional[bool] = None, hidden_prehistory: Optional[bool] = None, can_set_location: Optional[bool] = None, has_scheduled: Optional[bool] = None, can_view_stats: Optional[bool] = None, blocked: Optional[bool] = None, can_delete_channel: Optional[bool] = None, antispam: Optional[bool] = None, participants_hidden: Optional[bool] = None, translations_disabled: Optional[bool] = None, stories_pinned_available: Optional[bool] = None, view_forum_as_messages: Optional[bool] = None, restricted_sponsored: Optional[bool] = None, can_view_revenue: Optional[bool] = None, paid_media_allowed: Optional[bool] = None, can_view_stars_revenue: Optional[bool] = None, paid_reactions_available: Optional[bool] = None, stargifts_available: Optional[bool] = None, paid_messages_available: Optional[bool] = None, participants_count: Optional[int] = None, admins_count: Optional[int] = None, kicked_count: Optional[int] = None, banned_count: Optional[int] = None, online_count: Optional[int] = None, exported_invite: Optional["raw.base.ExportedChatInvite"] = None, migrated_from_chat_id: Optional[int] = None, migrated_from_max_id: Optional[int] = None, pinned_msg_id: Optional[int] = None, stickerset: Optional["raw.base.StickerSet"] = None, available_min_id: Optional[int] = None, folder_id: Optional[int] = None, linked_chat_id: Optional[int] = None, location: Optional["raw.base.ChannelLocation"] = None, slowmode_seconds: Optional[int] = None, slowmode_next_send_date: Optional[int] = None, stats_dc: Optional[int] = None, call: Optional["raw.base.InputGroupCall"] = None, ttl_period: Optional[int] = None, pending_suggestions: Optional[List[str]] = None, groupcall_default_join_as: Optional["raw.base.Peer"] = None, theme_emoticon: Optional[str] = None, requests_pending: Optional[int] = None, recent_requesters: Optional[List[int]] = None, default_send_as: Optional["raw.base.Peer"] = None, available_reactions: Optional["raw.base.ChatReactions"] = None, reactions_limit: Optional[int] = None, stories: Optional["raw.base.PeerStories"] = None, wallpaper: Optional["raw.base.WallPaper"] = None, boosts_applied: Optional[int] = None, boosts_unrestrict: Optional[int] = None, emojiset: Optional["raw.base.StickerSet"] = None, bot_verification: Optional["raw.base.BotVerification"] = None, stargifts_count: Optional[int] = None, send_paid_messages_stars: Optional[int] = None, main_tab: Optional["raw.base.ProfileTab"] = None, guard_bot_id: Optional[int] = None) -> None:
        self.id = id  # long
