...
class StoryItem(TLObject):
    ...
    Parameters:
        ...
        music (:obj:`Document <pyrogram.raw.base.Document>`, *optional*):
            If set, the audio track played as background music for the story.
    ...
    def __init__(self, *, id: int, date: int, expire_date: int, media: "raw.base.MessageMedia", pinned: Optional[bool] = None, public: Optional[bool] = None, close_friends: Optional[bool] = None, min: Optional[bool] = None, noforwards: Optional[bool] = None, edited: Optional[bool] = None, contacts: Optional[bool] = None, selected_contacts: Optional[bool] = None, out: Optional[bool] = None, from_id: Optional["raw.base.Peer"] = None, fwd_from: Optional["raw.base.StoryFwdHeader"] = None, caption: Optional[str] = None, entities: Optional[List["raw.base.MessageEntity"]] = None, media_areas: Optional[List["raw.base.MediaArea"]] = None, privacy: Optional[List["raw.base.PrivacyRule"]] = None, views: Optional["raw.base.StoryViews"] = None, sent_reaction: Optional["raw.base.Reaction"] = None, albums: Optional[List[int]] = None, music: Optional["raw.base.Document"] = None) -> None:
        self.id = id  # int
        self.date = date  # int
